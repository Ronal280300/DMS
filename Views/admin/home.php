                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-flex">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item hidden-on-mobile">
                                    <a class="nav-link language-dropdown-toggle" href="#" id="languageDropDown" data-bs-toggle="dropdown"><img src="<?php echo BASE_URL . 'Assets/images/flags/us.png'; ?>"></a>
                                        <ul class="dropdown-menu dropdown-menu-end language-dropdown" aria-labelledby="languageDropDown">
                                            <li><a class="dropdown-item" href="#"><img src="<?php echo BASE_URL . 'Assets/images/flags/germany.png'; ?>" alt="">German</a></li>
                                            <li><a class="dropdown-item" href="#"><img src="<?php echo BASE_URL . 'Assets/images/flags/italy.png'; ?>" alt="">Italian</a></li>
                                            <li><a class="dropdown-item" href="#"><img src="<?php echo BASE_URL . 'Assets/images/flags/china.png'; ?>" alt="">Chinese</a></li>
                                        </ul>
                                </li>
                                <li class="nav-item hidden-on-mobile">
                ...
                <div class="content-wrapper">
                    <div class="container">
                                        ...
                                        <div class="widget-payment-request-container">
                                            ...
                                            <div class="widget-payment-request-product">
                                                <div class="widget-payment-request-product-image m-r-sm">
                                                    <img src="<?php echo BASE_URL . 'Assets/images/other/facebook_logo.png'; ?>" class="mt-auto" alt="">
                                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="widget-popular-product-container">
                                            <div class="widget-popular-product-image">
                                                <img src="<?php echo BASE_URL . 'Assets/images/widgets/popular-product.jpeg'; ?>" alt="">
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="card">
                                    <img src="<?php echo BASE_URL . 'Assets/images/widgets/blog5.jpeg'; ?>" class="card-img-top" alt="...">
                                    <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        <div class="widget-popular-blog-container">
                                            <div class="widget-popular-blog-image">
                                                <img src="<?php echo BASE_URL . 'Assets/images/widgets/product2.jpeg'; ?>" alt=""> 
                                            </div>
