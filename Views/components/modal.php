        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-grid">
                    ...
                    <button type="button" id="btnSubirArchivo" class="btn btn-outline-success m-r-xs"><i class="material-icons">upload_file</i>Cargar Archivos</button>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-grid">
                    ...
                    <hr>
                    <button type="button" id="btnSubir" class="btn btn-outline-primary m-r-xs"><i class="material-icons">folder_zip</i>Cargar archivos</button>
                    <hr>
