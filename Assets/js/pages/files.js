...
document.addEventListener('DOMContentLoaded', function () {
    ...
    eliminar.forEach(enlace => {
        enlace.addEventListener('click', function (e) {
            ...
            eliminarRegistro('¿DESEA ELIMINAR EL ARCHIVO?', 'EL ARCHIVO SE ELIMINARÁ DE FORMA PERMANENTE EN 30 DIAS', 'ELIMINAR', url, null)
        })
    });
})
...
Dropzone.options.uploadForm = {
    dictDefaultMessage: 'ARRASTRA Y SUELTA LOS ARCHIVOS',
